...
CardDb[Card.NAME.HIRELING] = new CardDbRecord(Hireling, Card.NAME.HIRELING, [Card.TYPE.ACTION, Card.TYPE.DURATION], new Cost(6, 0, 0), 0,
  10, SupplyPileFactory.createForNormalCard);
CardDb[Card.NAME.PIRATE] = new CardDbRecord(Pirate, Card.NAME.PIRATE, [Card.TYPE.ACTION, Card.TYPE.DURATION], new Cost(5, 0, 0), 0,
  10, SupplyPileFactory.createForNormalCard);
CardDb[Card.NAME.SHEPHERD] = new CardDbRecord(Shepherd, Card.NAME.SHEPHERD, [Card.TYPE.ACTION], new Cost(4, 0, 0), 0,
  10, SupplyPileFactory.createForNormalCard);
CardDb[Card.NAME.SOUK] = new CardDbRecord(Souk, Card.NAME.SOUK, [Card.TYPE.ACTION], new Cost(5, 0, 0), 0,
  10, SupplyPileFactory.createForNormalCard);
